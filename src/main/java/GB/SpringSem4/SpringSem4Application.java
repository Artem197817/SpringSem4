 ...
 * Создайте простую страницу с некоторыми переменными, которые заполняются с помощью модели Spring MVC и о
 * тображаются на странице с использованием Thymeleaf.
...
public class SpringSem4Application {

	public static void main(String[] args) {
		SpringApplication.run(SpringSem4Application.class, args);
	}
